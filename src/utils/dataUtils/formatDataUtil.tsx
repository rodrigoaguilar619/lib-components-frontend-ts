 ...
 * @param {boolean} addSymbol - Whether to add the currency symbol
 * @return {string} The formatted currency string
 */
export function formatCurrency(number: any, decimalSpaces: number | undefined, addZeroPad: boolean, addSeparateComma: boolean, addSymbol: boolean) {
    return ((addSymbol === true) ? "$ ": "") + formatNumberDecimal(number, decimalSpaces, addZeroPad, addSeparateComma);
}