...
describe('DataTableComponent', () => {
  ...
  const mockColumnDefList: DataTablePropsI[] = [
    { field: 'id', header: 'ID', tableConfig: { sortable: true, aligns: { alignHeader: 'right', alignCell: 'right' } } },
    { field: 'name', header: 'Name', tableConfig: { sortable: true } },
    { field: 'age', header: 'Age', tableConfig: { sortable: true } }
  ];
